  ...
  return (
    <form onSubmit={onSubmitHandler} className='min-h-[80vh] flex items-center  '>
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border border-gray-200 rounded-xl text-[#5E5E5E] text-sm shadow-lg'>
        ...
        {
          state === 'Admin' ? <p>Doctor Login? <span className='cursor-pointer text-primary' onClick={() => setState('Doctor')}>Click Here</span></p>:<p>Admin Login? <span className='cursor-pointer text-primary' onClick={() => setState('Admin')}>Click Here</span></p>
        }
      </div>
    </form>
  )
